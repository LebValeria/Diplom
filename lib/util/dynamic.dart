 ...
 */
/*
 * copy flutter_screenutil 1.0.2 with dynamic icon size
 */
...
class ScreenUtil {
  ...
  double get uiDiagonal  => sqrt(pow(uiWidthPx, 2) + pow(uiHeightPx, 2));

  double get deviceDiagonal => sqrt(pow(_screenWidth, 2) + pow(_screenHeight, 2));

  double get relation => deviceDiagonal / uiDiagonal;
  ...
  num setIcon(num size) => size * scaleWidth;
}
